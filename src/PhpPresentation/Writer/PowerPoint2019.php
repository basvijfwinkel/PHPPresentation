...
use PhpOffice\PhpPresentation\Writer\PowerPoint2019\AbstractDecoratorWriter;
use ReflectionClass;

/**
 * \PhpOffice\PhpPresentation\Writer\PowerPoint2019
 */
class PowerPoint2019 extends AbstractWriter implements WriterInterface
{
    /**
    ...
    /**
     * Create a new PowerPoint2019 file.
     */
    ...
    public function save(string $pFilename): void
    {
        ...
        $oDir = new DirectoryIterator(__DIR__ . DIRECTORY_SEPARATOR . 'PowerPoint2019');
        $arrayFiles = [];
        foreach ($oDir as $oFile) {
            ...
            $class = __NAMESPACE__ . '\\PowerPoint2019\\' . $oFile->getBasename('.php');
