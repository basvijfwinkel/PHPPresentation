 ...
 */
class PowerPoint2019 extends DebugBase implements ReaderInterface
{
    /**
     * Output Object.
     *
...
//$this->e('Starting to parse the view properties');
        // load all viewProps data from the input string
        $parseErrors = $this->oPhpPresentation->getViewProps()->loadFromXMLString($sPart);
        if ($parseErrors)
        {
            // there were some parse errors while loading the data from the xml
$this->e('There were parse errors:');
$this->e($this->oPhpPresentation->getViewProps()->getParsingErrors());
        }
/*        else
        {
$this->e('No parse errors');
        }
*/
