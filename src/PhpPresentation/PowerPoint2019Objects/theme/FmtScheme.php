 ...
 * fmtScheme element
 */
class FmtScheme extends PP2019Element
{
    protected $elementName = 'fmtScheme';
    ...
    protected $knownChildNodes  = [
                                   'fillStyleLst'   => ['type' => 'FillStyleLst'  ],
                                   'lnStyleLst'     => ['type' => 'LnStyleLst'    ],
                                   'effectStyleLst' => ['type' => 'EffectStyleLst'],
                                   'bgFillStyleLst' => ['type' => 'BgFillStyleLst'],
                                  ];
