 ...
 */
class ThemeElements extends PP2019Element
{
    protected $elementName = 'themeElements';
    ...
    protected $knownChildNodes  = [
                                   'clrScheme'  => ['type' => 'ClrScheme' ],
                                   'fontScheme' => ['type' => 'FontScheme'],
                                   'fmtScheme'  => ['type' => 'FmtScheme' ],
                                  ];
