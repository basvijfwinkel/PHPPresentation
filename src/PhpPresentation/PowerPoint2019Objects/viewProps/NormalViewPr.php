...
/**
 * normalViewPr element
 */
class NormalViewPr extends PP2019Element
{
    protected $elementName = 'normalViewPr';
    ...
    protected $knownChildNodes  = [
                                   'restoredLeft'    => ['type' => 'RestoredLeft'  ],
                                   'restoredTop'     => ['type' => 'RestoredTop' ],
                                  ];
