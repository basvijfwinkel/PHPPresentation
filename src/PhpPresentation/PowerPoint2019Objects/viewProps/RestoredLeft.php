...
/**
 * restoredLeft element
 */
class RestoredLeft extends PP2019Element
{
    protected $elementName = 'restoredLeft';
    protected $elementNamespace = 'p';

    protected $knownAttributes = [
                                  'autoAdjust' => ['type' => 'integer'],
                                  'sz'         => ['type' => 'integer']
                                 ];

    protected $childNodeDefaultNamespace = '';
